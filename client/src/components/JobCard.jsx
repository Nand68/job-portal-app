  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='mt-4 flex gap-4 text-sm'> 
        <button className='bg-blue-600 text-white px-4 py-2 rounded' type="button">Apply now</button>
        <button className='text-gray-500 border border-gray-500 rounded px-4 py-2' type="button">Learn more</button>
      </div>
    </div>
  );
};
